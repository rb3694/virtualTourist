...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func checkIfFirstLaunch() {
        if !UserDefaults.standard.bool(forKey: VTClient.Defaults.HasLaunched) {
            ...
            UserDefaults.standard.set(defaultMapCenter.latitude, forKey: VTClient.Defaults.MapCenterLatitude)
            UserDefaults.standard.set(defaultMapCenter.longitude, forKey: VTClient.Defaults.MapCenterLongitude)
            UserDefaults.standard.set(defaultSpan.latitudeDelta, forKey: VTClient.Defaults.MapLatDelta)
            UserDefaults.standard.set(defaultSpan.longitudeDelta, forKey: VTClient.Defaults.MapLongDelta)
        }
    }
